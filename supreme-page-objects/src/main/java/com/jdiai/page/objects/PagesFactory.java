...
public class PagesFactory {
    ...
    public MapArray<String, AnnotationRule<?>> annotations = new MapArray<>();
    public MapArray<String, SetupRule> setupRules = new MapArray<String, SetupRule>(
        ...
        $("Annotations", sRule(
            ...
            info -> {
                for (AnnotationRule ar : annotations.values()) {
                    if (info.field.isAnnotationPresent(ar.annotation)) {
                        ar.action.execute(info.instance, info.field.getAnnotation(ar.annotation), info.field);
                    }
                }
            }))
    );
